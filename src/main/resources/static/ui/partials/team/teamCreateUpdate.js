app.controller('teamCreateUpdateCtrl',
    ['ScreenService', 'TeamService', 'RoleService', 'NotificationProvider', '$scope', '$rootScope', '$timeout', '$log', '$uibModalInstance', 'title', 'action', 'team',
        function (ScreenService, TeamService, RoleService, NotificationProvider, $scope, $rootScope, $timeout, $log, $uibModalInstance, title, action, team) {
